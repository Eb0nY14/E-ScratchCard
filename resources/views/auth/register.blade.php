...
CODE TITLE: register.blade.php
DATE: 01 APRIL 2020

PURPOSE: THE PURPOSE OF THIS PHP CODE IS TO CREATE AND DISPLAY THE VIEW FOR USER REGISTRATION. IT USES THE LARAVEL IN-BUILT TEMPLATE WHOSE CODE CAN BE FOUND IN THE
FOLDERS qlotto > resources > views > layouts > base.blade.php and I EXTENDED THE CODE IN THIS FILE WITH ADDITIONAL CODES WRITTEN BY ME. THE FIRST LINE OF CODE ON LINE
14 REFERS TO THE LARAVEL LAYOUT TEMPLATE USED AND NOTIFIES LARAVEL THAT THIS TEMPLATE CODE SHOULD BE INCLUDED WITH THE register.blade.php CODE, ALL OTHER LINES OF CODE
IN THIS FILE WERE WRITTEN BY ME.
