...
CODE TITLE: profile.blade.php
DATE: 06 APRIL 2020

PURPOSE: THE PURPOSE OF THIS PHP CODE IS TO CREATE A "PROFILE" FORM SCREEN THAT WILL ALLOW THE USER TO VIEW AND EDIT THEIR PERSONAL PROFILE INFORMATION
SUCH AS PAYMENT OR PERSONAL INFORMATION.  IT USES THE LARAVEL IN-BUILT TEMPLATE WHOSE CODE CAN BE FOUND IN THE FOLDERS qlotto > resources > views > layouts > 
base.blade.php and I EXTENDED THE CODE IN THIS FILE WITH ADDITIONAL CODES WRITTEN BY ME. THE FIRST LINE OF CODE ON LINE 14 REFERS TO THE LARAVEL LAYOUT TEMPLATE
USED AND NOTIFIES LARAVEL THAT THIS TEMPLATE CODE SHOULD BE INCLUDED WITH THE profile.blade.php CODE, ALL OTHER LINES OF CODE IN THIS FILE WERE WRITTEN BY ME.
